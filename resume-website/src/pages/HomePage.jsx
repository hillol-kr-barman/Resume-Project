        ...
        <div className="mx-auto max-w-2xl py-12 sm:py-16 lg:py-20">
          <div className="text-center">
            <h1 className="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">
              Personal Resume Showcase
            </h1>
            <p className="mt-5 text-sm font-normal text-pretty text-gray-400 sm:text-lg/6">
              Showcase of my skills and project to get you a better idea of my best capabilities
            </p>

            <div className="mt-7 flex items-center justify-center gap-x-4">
              <a
                href="#"
                className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-none hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Get started
              </a>
              ...
              <button
                type="button"
                className="rounded-md bg-indigo-500 px-2.5 py-1.5 text-sm font-semibold text-white shadow-none hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
