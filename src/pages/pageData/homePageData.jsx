...
export const projects = [
  {
    ...
    content: 'A standalone web app for exploring GitHub repository activity through a readable workflow graph. The app supports GitHub sign-in, repository selection, recent commit details, branch labels, manual refresh, opt-in auto-refresh, and read-only GitHub API access through a backend service.',
